...
(function ($) {
  ...
  var WidgetCountdown = function WidgetCountdown($scope, $) {
    ...
    var comingSoon = function comingSoon() {
      var countdowns = document.querySelectorAll('.mintie-countdown-wrapper');
      ...
      countdowns.forEach(function (countdownContainer) {
        ...
        var countdown = Doom({
          ...
          ids: {
            days: digits[0].querySelector('.mintie-countdown-digit').id,
            hours: digits[1].querySelector('.mintie-countdown-digit').id,
            mins: digits[2].querySelector('.mintie-countdown-digit').id,
            secs: digits[3].querySelector('.mintie-countdown-digit').id
          }
        });
  ...
  $(window).on('elementor/frontend/init', function () {
    elementorFrontend.hooks.addAction('frontend/element_ready/mintie-countdown.default', WidgetCountdown);
  });
})(jQuery);