...
(function ($) {
  var MintieTestimonial = function MintieTestimonial($scope, $) {
  ...
  $(window).on('elementor/frontend/init', function () {
    elementorFrontend.hooks.addAction('frontend/element_ready/mintie-testimonial.default', MintieTestimonial);
  });
})(jQuery);