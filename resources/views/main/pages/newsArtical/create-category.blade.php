    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-8">
            ...
            <ol class="breadcrumb">
                ...
                {{-- <li class="breadcrumb-item"><a href="{{ route('admin-case.create') }}">Add Case Studies</a></li> --}}
                <li class="breadcrumb-item"><a href="{{ route('admin-news-category.create') }}">Add News Category</a>
                </li>
            </ol>
        </div>
        <div class="col-sm-4">
        ...
        <div class="animated fadeInUp">
            <form action="{{ route('admin-news-category.store') }}" method="POST" enctype="multipart/form-data">
                ...
                @if (isset($news_categories))
                    {{-- {{dd($news_categories)}} --}}
                    <input hidden value="{{ $news_categories->id }}" name="news_categories_id" />
                @endif
                <div class="form-group">
                    <label for="exampleInputEmail1">Category Name</label>
                    <input type="text" class="form-control" name="category_title" required
                        placeholder="Enter Category Name"
                        value="{{ isset($news_categories) ? $news_categories->category_title : '' }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="category_description" required
                        ...
                        value="{{ isset($news_categories) ? $news_categories->category_description : '' }}">
                </div>


                <div class="form-group">
                    <label for="editor">Category Details</label>
                    <textarea class="editor" name="editor" id="editor">{!! isset($news_categories) ? $news_categories->category_body : '' !!}</textarea>
                </div>

                <div class="form-group">
                    <label for="category_thumbnail">Category Thumbnail</label>
                    <input type="file" name="category_thumbnail" class="form-control"
                        {{ isset($news_categories) ? '' : 'required' }} />
                    <img src="{{ isset($news_categories) ? $news_categories->category_thumbnail : '' }}" style="height: 200px;"
                        alt="" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="category_banner" class="form-control"
                        {{ isset($news_categories) ? '' : 'required' }} />
                    <img src="{{ isset($news_categories) ? $news_categories->category_banner : '' }}" style="height: 200px;"
                        alt="" />
                </div>
                ...
                <fieldset class="border p-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="meta_title" class="form-control" required
                            value="{{ isset($news_categories) ? $news_categories->meta_title : '' }}" />
                    </div>

                    <div class="form-group">
                        <label class="control-label">Meta Description</label>
                        <input class="form-control" required type="text" name="meta_desc"
                            value="{{ isset($news_categories) ? $news_categories->meta_desc : '' }}" />
                    </div>

                    <div class="form-group">
                        <label class="control-label">Meta Keywords</label>
                        <input class="form-control" required type="text" name="meta_keywords"
                            value="{{ isset($news_categories) ? $news_categories->meta_keywords : '' }}" />
                    </div>
                ...
                <fieldset class="border p-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="og_title" class="form-control" required
                            value="{{ isset($news_categories) ? $news_categories->og_title : '' }}" />
                    </div>

                    <div class="form-group">
                        <label class="control-label">OG Description</label>
                        <input class="form-control" required type="text" name="og_desc"
                            value="{{ isset($news_categories) ? $news_categories->og_desc : '' }}" />

                    </div>

                    <div class="mb-3">
                        <label for="formFileSm" class="form-label">OG Image</label>
                        <input class="form-control form-control-sm" name="og_image" id="og_image" type="file" {{ isset($news_categories) ? '' : 'required' }}>
                        <img src="{{ isset($news_categories) ? $news_categories->og_image : '' }}" style="height: 200px;"alt="" />
                    </div>
