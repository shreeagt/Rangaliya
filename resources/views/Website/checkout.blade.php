...
@section('content')
    ...
    <div class="container">
        ...
        <div class="checkout-section">
            <div>
                <form name="storeCheckout" action="{{ route('checkout.store') }}" method="POST" id="payment-form">
                    {{ csrf_field() }}
                    ...
                    <button id="complete-order" class="button-primary full-width border-0">Complete Order</button>
                  
                    <input type="hidden" id="rzp_paymentid" value="" name="rzp_paymentid"/>
                </form>
                ...
                <div class="checkout-table">
                    ...
                    <div class="checkout-table-row">
                        ...
                        <div class="checkout-table-row-right">
                            <div class="checkout-table-quantity">{{ $item->product_quantity }}</div>
                        </div>
