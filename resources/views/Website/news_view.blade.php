...
@section('main-section')
    ...
    <span><a href="{{ route('news') }}">news</a></span>
    <i class="fa fa-chevron-right breadcrumb-separator"></i>
    <span>{{ $news_details->news_title }}</span>
    <style> 
    .service_image{
        text-align: left;
    }
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <div class="postSingle">               
                    ...
                    <div class="postMedia">                    
                        <img  src="<?php echo env('IMAGE_URL_CONSTANT').$news_details->news_banner ?>" class="parallax-inner back-img desktop-image w-100" alt="{{$news_details->news_title}}">
                    </div><!--Post image-->
                    ...
                    <div class="postMeta clearfix">
                        ...
                        <div class="postMeta-date">
                            <span class="time"><i class="fa fa-calendar"></i>
                                {{Carbon\Carbon::parse($news_details->created_at)->format('M d, Y')}}</span>
                        </div>
                    </div><!--Post meta-->
