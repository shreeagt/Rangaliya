...
<!-- @push('title')
    <title>blogs</title>
@endpush -->
<link rel='stylesheet' id='wc-blocks-vendors-style-css' href="{{ asset('css/rangrilya/post-8248.css') }}" type='text/css'
    media='all' />
<link rel='stylesheet' id='wc-blocks-vendors-style-css' href="{{ asset('css/rangrilya/style2.css') }}" type='text/css'
    media='all' />
<!-- <link rel='stylesheet' id='wc-blocks-vendors-style-css' href="{{ asset('css/rangrilya/post-8248.css') }}" type='text/css' media='all' /> -->
<link rel='stylesheet' id='wc-blocks-vendors-style-css' href="{{ asset('css/rangrilya/styleblog.css') }}"
    ...
    <div class="row">
        <main id="main" class="col-md-8 col-lg-8">
            <div class="postSingle">
                <div class="postMedia">
                    {{-- <img src="<?php echo env('IMAGE_URL_CONSTANT') . $blog_details->blog_banne; ?>" class="parallax-inner back-img desktop-image w-100"
                        alt="{{ $blog_details->blog_title }}"> --}}
                        ...
                        <form role="search" method="get" action=""
                            ...
                            <div class="wp-block-search__inside-wrapper ">
                                <input type="search" id="wp-block-search__input-1" class="wp-block-search__input"
                                    name="s" value="" placeholder="Enter keyword..." required />
                                <button type="submit" class="wp-block-search__button has-icon wp-element-button"
                                    aria-label="Search">
                            ...
                            <li class="mintie-entry">
                                <div class="mintie-entry-thumbnail">
                                    <a href="<?php echo url('/blog/' . $latest['blog_url']); ?>" aria-hidden="true" tabindex="-1">
                                        <img width="150" height="150" src="{{ $latest['blog_thumbnail'] }}"
                                            class="attachment-thumbnail size-thumbnail wp-post-image" alt="image"
                                            decoding="async" loading="lazy" srcset="{{ $latest['blog_thumbnail'] }}"
                                            sizes="(max-width: 150px) 100vw, 150px" /> </a>
                                </div>
                                <div class="mintie-recent-post-detail">
                                    <a href="<?php echo url('/blog/' . $latest['blog_url']); ?>" class="mintie-recent-post-title">
                                        {{ $latest['blog_title'] }}</a>
                                </div>
                            </li>
                            <?php  } ?>
