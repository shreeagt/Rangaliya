...
class CreateCaseStudiesCategoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('case_studies_category', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('case_studies_category');
    }
}
